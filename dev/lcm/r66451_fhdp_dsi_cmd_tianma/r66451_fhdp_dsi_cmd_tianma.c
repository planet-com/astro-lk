...
#ifdef CONFIG_MTK_HIGH_FRAME_RATE
static void lcm_dfps_int(LCM_DSI_PARAMS *dsi)
{
...
//	dfps_params[0].vertical_frontporch_for_low_power_dyn = 2500;
	...
	dfps_params[1].fps = DEFAULT_FPS;/*real fps * 100, to support float*/
	dfps_params[1].vact_timing_fps = DEFAULT_FPS;/*real vact timing fps * 100*/
	/*if mipi clock solution*/
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.data_rate = 700;
#else
	params->dsi.PLL_CLOCK = 190;
	params->dsi.data_rate = 380;
#endif
...
static bool lcm_dfps_need_inform_lcm(
	unsigned int from_level, unsigned int to_level, LCM_PARAMS* params)
{
	...
	p_dfps_cmds = &(dfps_cmd_table[from_level][to_level]);
