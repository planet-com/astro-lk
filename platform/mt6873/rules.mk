...
MTK_LOGO_RUNTIME_SWITCH ?= yes
ifeq ($(MTK_LOGO_RUNTIME_SWITCH), yes)
DEFINES += MTK_LOGO_RUNTIME_SWITCH
endif

ifeq ($(MTK_RUNTIME_SWITCH_FPS_SUPPORT), yes)
DEFINES += MTK_RUNTIME_SWITCH_FPS_SUPPORT
endif
...
ifeq ($(I2C_MULTI_CH_MASK), yes)
	DEFINES += I2C_MULTI_CH_MASK
endif
