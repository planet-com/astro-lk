...
#define MSDC0_GPIO_IES_ADDR      (MSDC0_IO_PAD_BASE + 0x20)
#define MSDC0_GPIO_PUPD0_ADDR    (MSDC0_IO_PAD_BASE + 0x30)
#define MSDC0_GPIO_R0_ADDR       (MSDC0_IO_PAD_BASE + 0x40)
#define MSDC0_GPIO_R1_ADDR       (MSDC0_IO_PAD_BASE + 0x50)
#define MSDC0_GPIO_RDSEL0_ADDR   (MSDC0_IO_PAD_BASE + 0x60)
#define MSDC0_GPIO_RDSEL0_ADDR_1 (MSDC0_IO_PAD_BASE + 0x70)
#define MSDC0_GPIO_RDSEL0_ADDR_2 (MSDC0_IO_PAD_BASE + 0x80)
#define MSDC0_GPIO_SMT_ADDR      (MSDC0_IO_PAD_BASE + 0x90)
#define MSDC0_GPIO_TDSEL0_ADDR   (MSDC0_IO_PAD_BASE + 0xa0)
#define MSDC0_GPIO_TDSEL0_ADDR_1 (MSDC0_IO_PAD_BASE + 0xb0)
