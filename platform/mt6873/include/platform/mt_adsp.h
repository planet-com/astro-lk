...
#define ADSP_B_ITCM_NAME                "hifi3_b_iram"
#define ADSP_B_DTCM_NAME                "hifi3_b_dram"
#define ADSP_B_DRAM_NAME                "hifi3_b_sram"
#define ADSP_B_ITCM_BASE                0x10870000
#define ADSP_B_ITCM_SIZE                0x00009000
#define ADSP_B_DTCM_BASE                0x10850000
#define ADSP_B_DTCM_SIZE                0x00008000
#define ADSP_B_DRAM_BASE               (ADSP_A_DRAM_BASE + ADSP_A_DRAM_SIZE) //align adsp lsp: in adsp view

#ifdef FPGA_EARLY_DEVELOPMENT
#define ADSP_A_DRAM_SIZE                0x00380000
#define ADSP_B_DRAM_SIZE                0x00380000
#else
#define ADSP_A_DRAM_SIZE                0x00700000
#define ADSP_B_DRAM_SIZE                0x00700000
#endif

#define ADSP_TCM_TOTAL_SIZE             (ADSP_A_ITCM_SIZE + \
					ADSP_A_DTCM_SIZE + \
					ADSP_B_ITCM_SIZE + \
					ADSP_B_DTCM_SIZE)
#define ADSP_DRAM_BASE                  ADSP_A_DRAM_BASE
#define ADSP_DRAM_SIZE                  (ADSP_A_DRAM_SIZE + ADSP_B_DRAM_SIZE)
...
#define ADSPPLL_CON3                        (APMIXED_BASE + 0x037C)
	#define ADSPPLL_750M_REG            (0x821CD89D)
