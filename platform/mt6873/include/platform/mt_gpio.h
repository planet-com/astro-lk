...
/*----------------------------------------------------------------------------*/
typedef struct {
	VAL_REGS dir[7];        /*0x0000 ~ 0x006F: 128 bytes */
	u8 rsv00[144];          /*0x0070 ~ 0x00FF: 144 bytes */
	VAL_REGS dout[7];       /*0x0100 ~ 0x016F: 128 bytes */
	u8 rsv01[144];          /*0x0170 ~ 0x01FF: 144 bytes */
	VAL_REGS din[7];        /*0x0200 ~ 0x026F: 128 bytes */
	u8 rsv02[144];          /*0x0270 ~ 0x02FF: 144 bytes */
	VAL_REGS mode[28];      /*0x0300 ~ 0x04BF: 368 bytes */
} GPIO_REGS;
/******************************************************************************
