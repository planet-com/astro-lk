...
#define GPIO_USBL_PLUGIN_DET      (GPIO17 | 0x80000000)
...
kal_bool upmu_is_chr_det(void)
{
	...
	if (mt_get_gpio_in(GPIO_HDMI_HPD_DET) == 0 && mt_get_gpio_in(GPIO_USBL_PLUGIN_DET) == 0) {
		tmp32 = 1;
	}
	dprintf(CRITICAL, "[upmu_is_chr_det2] %d\n", tmp32);
