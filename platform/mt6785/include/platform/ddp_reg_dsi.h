...
#define DSI_PHY_SYSCON_FLD_HS_SYNC_CODE		REG_FLD_MSB_LSB(7, 0)
#define DSI_PHY_SYSCON_FLD_HS_SYNC_CODE2	REG_FLD_MSB_LSB(15, 8)
#define DSI_PHY_SYSCON_FLD_HS_SKEWCAL_PAT	REG_FLD_MSB_LSB(23, 16)
#define DSI_PHY_SYSCON_FLD_HS_DB_SYNC_EN	REG_FLD_MSB_LSB(24, 24)
