...
ddp_module  ddp_modules[DISP_MODULE_NUM] = {
		...
		{DISP_MODULE_CM0,"cm0",0,NULL},
		{DISP_MODULE_SPR0,"spr0",0,NULL},
		{DISP_MODULE_SPR0_VIRTUAL,"spr0_virtual",1,NULL},
...
int ddp_enable_module_clock(DISP_MODULE_ENUM module)
{
	...
	switch (module) {
		...
		case DISP_MODULE_DSC_WRAP0_CORE0:
			DISP_REG_SET_FIELD(NULL, FLD_CG0_DISP_DSC_WRAP, DISP_REG_CONFIG_MMSYS_CG_CLR0, 1);
			break;
		default:
...
int ddp_disable_module_clock(DISP_MODULE_ENUM module)
{
	...
	switch (module) {
		...
		case DISP_MODULE_CCORR0:
			...
			break;
		case DISP_MODULE_CCORR1:
			DISP_REG_SET_FIELD(NULL,FLD_CG0_DISP_CCORR1,DISP_REG_CONFIG_MMSYS_CG_SET0,1);
			break;
		case DISP_MODULE_AAL0:
		...
		case DISP_MODULE_RSZ0:
			...
			break;
		case DISP_MODULE_DSC_WRAP0_CORE0:
			DISP_REG_SET_FIELD(NULL, FLD_CG0_DISP_DSC_WRAP, DISP_REG_CONFIG_MMSYS_CG_SET0, 1);
			break;
		default:
