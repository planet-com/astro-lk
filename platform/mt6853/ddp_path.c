...
int primary_disp_dsc_module_list[DDP_ENING_NUM] = {
	...
	DISP_MODULE_POSTMASK0, DISP_MODULE_DITHER0, DISP_MODULE_SPR0_VIRTUAL,
...
static sel_t sel_in_map[] = {
	...
	/* DISP_BYPASS_SPR0_SEL_IN */
	{DISP_MODULE_SPR0_VIRTUAL, {DISP_MODULE_DITHER0,
	 DISP_MODULE_SPR0, -1}, 0, 0},
	...
	/* DISP_WDMA0_SEL_IN */
	{DISP_MODULE_WDMA0, {DISP_MODULE_SPR0_VIRTUAL,
...
int ddp_path_init(void)
{
	...
	sel_in_map[2].reg =
		(unsigned long *)DISP_BYPASS_SPR0_SEL_IN;
	sel_in_map[3].reg =
