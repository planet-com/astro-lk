...
void msdc_set_rdsel_by_id(u32 id, u32 flag, u32 value)
{
	...
	if (id == 0) {
		...
		MSDC_SET_FIELD(MSDC0_GPIO_RDSEL0_ADDR_2, MSDC0_RDSEL0_DSL_MASK,
			cust_val);
		MSDC_SET_FIELD(MSDC0_GPIO_RDSEL0_ADDR_2, MSDC0_RDSEL0_RSTB_MASK,
			cust_val);
	}
}
...
{
	if (id == 0) {
		MSDC_GET_FIELD(MSDC0_GPIO_DRV0_ADDR_1, MSDC0_DRV0_DSL_MASK,
			msdc_cap->ds_drv);
		MSDC_GET_FIELD(MSDC0_GPIO_DRV0_ADDR_1, MSDC0_DRV0_RSTB_MASK,
			msdc_cap->rst_drv);
		MSDC_GET_FIELD(MSDC0_GPIO_DRV0_ADDR_0, MSDC0_DRV0_CMD_MASK,
			msdc_cap->cmd_drv);
		MSDC_GET_FIELD(MSDC0_GPIO_DRV0_ADDR_0, MSDC0_DRV0_CLK_MASK,
			msdc_cap->clk_drv);
		MSDC_GET_FIELD(MSDC0_GPIO_DRV0_ADDR_0, MSDC0_DRV0_DAT0_MASK,
			msdc_cap->dat_drv);
		MSDC_GET_FIELD(MSDC0_GPIO_DRV0_ADDR_0, MSDC0_DRV0_DAT1_MASK,
			msdc_cap->dat_drv);
		MSDC_GET_FIELD(MSDC0_GPIO_DRV0_ADDR_0, MSDC0_DRV0_DAT2_MASK,
			msdc_cap->dat_drv);
		MSDC_GET_FIELD(MSDC0_GPIO_DRV0_ADDR_0, MSDC0_DRV0_DAT3_MASK,
			msdc_cap->dat_drv);
		MSDC_GET_FIELD(MSDC0_GPIO_DRV0_ADDR_0, MSDC0_DRV0_DAT4_MASK,
			msdc_cap->dat_drv);
		MSDC_GET_FIELD(MSDC0_GPIO_DRV0_ADDR_0, MSDC0_DRV0_DAT5_MASK,
			msdc_cap->dat_drv);
		MSDC_GET_FIELD(MSDC0_GPIO_DRV0_ADDR_0, MSDC0_DRV0_DAT6_MASK,
			msdc_cap->dat_drv);
		MSDC_GET_FIELD(MSDC0_GPIO_DRV0_ADDR_0, MSDC0_DRV0_DAT7_MASK,
			msdc_cap->dat_drv);
	}
}
#endif
...
{
	/*65 is the first msdc0 gpio*/
	int i, last_msdc_gpio = 65+11;

	for (i = 65; i <= last_msdc_gpio; i++)
	{	/* set GPIOx_MODE*/
