...
# The value would be overwritten if it is defined in [project].mk
...
DEFINES += BUS_DBG_NUMBER_V2
DEFINES += HAS_PLATFORM_BUS_DBG_BIT_FIELDS
DEFINES += BUSTRACKER
...
OBJS += \
	...
	$(LOCAL_DIR)/mtk_mfgsys.o\
	$(LOCAL_DIR)/aee_platform_debug.o\
	$(LOCAL_DIR)/mt_dummy_read.o\
	$(LOCAL_DIR)/mt_dramc_memtest.o\
	$(LOCAL_DIR)/../common/emi/emi_mpu_v2.o\
	$(LOCAL_DIR)/../common/emi/emi_info_v2.o\
	$(LOCAL_DIR)/../common/dramc/dramc_v1.o\
	$(LOCAL_DIR)/pll.o \
	$(LOCAL_DIR)/spm_mtcmos.o \
	...
	$(LOCAL_DIR)/pmif.o \
	$(LOCAL_DIR)/spmi_common.o \
	$(LOCAL_DIR)/spmi.o \
	$(LOCAL_DIR)/spmi_dbg.o \
	$(LOCAL_DIR)/mt_rtc.o \
...
ifeq ($(MTK_DPM_SUPPORT), yes)
DEFINES += MTK_DPM_SUPPORT
OBJS += $(LOCAL_DIR)/mt_dpm.o
endif
...
OBJS += $(LOCAL_DIR)/tinysys_platform.o
endif
...
ifdef MTK_SW_EFUSE_BONDING_DISPLAY
    DEFINES += MTK_SW_EFUSE_BONDING_DISPLAY=$(MTK_SW_EFUSE_BONDING_DISPLAY)
endif
ifdef MTK_SW_EFUSE_BONDING_CAMERA
    DEFINES += MTK_SW_EFUSE_BONDING_CAMERA=$(MTK_SW_EFUSE_BONDING_CAMERA)
endif
...
ifeq ($(MTK_MT6362_SUPPORT),yes)
	OBJS += $(LOCAL_DIR)/mt6362.o
	DEFINES += MTK_MT6362_SUPPORT
endif
...
ifeq ($(MTK_5G_B_MT6360_MT6315),yes)
	OBJS += $(LOCAL_DIR)/mt6315-spmi.o
	OBJS += $(LOCAL_DIR)/mt6360_pmic.o
	DEFINES += MTK_MT6360_PMIC_SUPPORT
	DEFINES += MTK_5G_B_MT6360_MT6315
endif

CFG_LOG_STORE_SUPPORT := yes

ifeq ($(MTK_TINYSYS_MCUPM_SUPPORT), yes)
	DEFINES += MTK_TINYSYS_MCUPM_SUPPORT
	OBJS += $(LOCAL_DIR)/mt_mcupm_excep.o
endif

SUPPORT_ARMV7VE := true

# gpu dfd dump
DEFINES += MTK_GPU_DFD_SUPPORT
