...
// APB Module pmif for spmi-p
#define PMIF_SPMI_P_BASE	(0x10024000)
// APB Module spmimst
#define SPMI_MST_P_BASE	(0x10025000)
...
// APB Module mdp_rdma
#define MDP_RDMA0_BASE (0x1F001000)
...
#define DISP_POSTMASK0_BASE	(0x1400E000)
#define DISP_CM0_BASE		(0x14010000)
#define DISP_SPR0_BASE		(0x14011000)
#define DISP_DSC_BASE		(0x14012000)
#define DSI0_BASE			(0x14013000)
#define DSI1_BASE			(0x1410E000)
#define DISP_WDMA0_BASE		(0x14014000)
...
#define CCORR0_BASE (0x1400B000)
#define CCORR1_BASE (0x1400A000)
#define DISP_AAL0_BASE (0x1400C000)
#define DISP_GAMMA0_BASE (0x1400D000)
#define DITHER0_BASE (0x1400F000)
...
#define SMI_SUBCOM0_BASE (0x1401B000)

// APB Module smi_subcom1
#define SMI_SUBCOM1_BASE (0x1401C000)
