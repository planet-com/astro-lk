...
#define DISP_REG_DSI_SELF_PAT_CON0            (0x178UL)
	#define DSI_SELF_PAT_PRE_MODE                          REG_FLD_MSB_LSB(0, 0)
	#define DSI_SELF_PAT_POST_MODE                         REG_FLD_MSB_LSB(1, 1)
	#define DSI_SELF_PAT_SEL                         		REG_FLD_MSB_LSB(7, 4)
	#define DSI_SELF_PAT_LEVEL                         		REG_FLD_MSB_LSB(9, 8)
	#define DSI_SELF_PAT_R                         		REG_FLD_MSB_LSB(27, 16)
#define DISP_REG_DSI_SELF_PAT_CON1             (0x17CUL)
	#define DSI_SELF_PAT_G                         		REG_FLD_MSB_LSB(11, 0)
	#define DSI_SELF_PAT_B                         		REG_FLD_MSB_LSB(27, 16)
