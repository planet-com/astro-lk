...
#define MTK_POL_DEPRECATED

#define INT_MSK_CTL0            (MCUCFG_BASE + 0xd6d0)
...
#define MT_MSDC0_IRQ_ID 131
#define MT_MSDC1_IRQ_ID 135
#define MT_UFS_IRQ_ID   137

#define MT_NR_PPI    (5)
#define MT_NR_SPI    (503)
