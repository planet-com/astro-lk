...
extern void sw_efuse_apply_devinfo(u32 sw_efuse_bonding);
...
void mt_efuse_apply_sw_bonding(void)
{
	unsigned int sw_efuse = 0;

#ifdef MTK_SW_EFUSE_BONDING_DISPLAY
	sw_efuse |= MTK_SW_EFUSE_BONDING_DISPLAY<<0;
#endif
#ifdef MTK_SW_EFUSE_BONDING_CAMERA
	sw_efuse |= MTK_SW_EFUSE_BONDING_CAMERA<<2;
#endif
	sw_efuse_apply_devinfo(sw_efuse);
}
