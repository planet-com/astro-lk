...
#ifndef CLK_CFG_9
#define CLK_CFG_9 0x100000A0
#endif

#ifndef CLK_CFG_9_SET
#define CLK_CFG_9_SET 0x100000A4
#endif

#ifndef CLK_CFG_9_CLR
#define CLK_CFG_9_CLR 0x100000A8
#endif
	...
	if (cust_led_list) {
		...
		if ((strcmp(cust->name,"lcd-backlight") == 0) && (cust->mode == MT65XX_LED_MODE_CUST_BLS_PWM)) {
			...
			if (config_data->clock_source >= 0 && config_data->clock_source <= 4) {
				...
				PWM_DBG("disp_pwm_init : CLK_CFG_9 0x%x => 0x%x", reg_val, PWM_REG_GET(CLK_CFG_9));
			}
			/*
