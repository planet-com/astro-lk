...
#define SCP_DRAM_SIZE			0x00400000  // 2M = dram start, +2M dram/dram backup)
...
#define SCP_SRAM_SIZE			0x00180000
...
#define SCP_L1C_OFFSET              0x200000  //fixed offset
#define SCP_L1C_SIZE                0x100000 //1MB
#define SCP_L1C_BACKUP_OFFSET       0x300000 //fixed offset

/*image name definition*/
#define IMG_NAME_SCP_A		"tinysys-scp-RV33_A"
#define L1C_NAME_SCP_A		"tinysys-scp-RV33_A_dram"
