...
#define OTHER_PWR_STATUS	SPM_REG(0x178)	/* for MT6885 VPU only */
...
extern int spm_mtcmos_ctrl_mdp(int state);
...
extern int spm_mtcmos_ctrl_mfg4(int state);
extern int spm_mtcmos_ctrl_mfg5(int state);
extern int spm_mtcmos_ctrl_mfg6(int state);
#endif
