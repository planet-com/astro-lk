...
#define MIPI_TX1_BASE (0x11E60000)

// MIPI TX Config
#define MIPI_TX0_CONFIG_BASE (0x11E50000)
#define MIPI_TX1_CONFIG_BASE (0x11E60000)
...
// APB Module mdp_aal
#define MDP_AAL4_BASE (0x14010000)
...
#define DISP_DP_INTF_BASE (0X14125000)
