...
typedef PACKING union
{
    ...
    UINT32 Raw;
} REG_DISP_MUTEX0_MOD1, *PREG_DISP_MUTEX0_MOD1;
...
typedef struct
{
    ...
    REG_DISP_MUTEX0_MOD1            DISP_MUTEX0_MOD1;    //14001034
...
typedef volatile PACKING struct
{
    ...
    REG_DISP_MUTEX0_MOD1            DISP_MUTEX0_MOD1;    	//14016034
    UINT32                          rsv_6034[2];      		//14016038..603C
...
#define DISP_MUTEX0_MOD1                                       (U32)(&DISP_MUTEX_BASE->DISP_MUTEX0_MOD1) // 6034
