...
static int cal_c_smem_size_and_layout(int load_flag)
{
	...
	unsigned long long ccb_data_buf = 0;
...
#define MPU_REGION_ID_MD1_C_SMEM        24
#define MPU_REGION_ID_MD1_NC_SMEM       25
...
static const mpu_att_t mpu_att_default[MPU_REGION_ID_TOTAL_NUM][MPU_MDOMAIN_ID_TOTAL_NUM] = {
	...
	/*31*/{
		NO_PROTECTION,  [1 ... 3] = FORBIDDEN, NO_PROTECTION, NO_PROTECTION, SEC_R_NSEC_RW,
		FORBIDDEN, NO_PROTECTION, NO_PROTECTION, FORBIDDEN, [11 ... 13] = NO_PROTECTION, [14 ... 15] = FORBIDDEN
	},
};
