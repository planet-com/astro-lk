...
ddp_module  ddp_modules[DISP_MODULE_NUM] = {
		...
		{DISP_MODULE_MDP_AAL5,"mdp_aal5",1,NULL},
...
int ddp_disable_module_clock(DISP_MODULE_ENUM module)
{
	...
	switch (module) {
		...
		case DISP_MODULE_DSI1:
			/*
			DISP_REG_SET_FIELD(NULL,FLD_CG2_DSI1,DISP_REG_CONFIG_MMSYS_CG_SET2,1);
			DISP_REG_SET_FIELD(NULL,FLD_CG0_DSI1_MM,DISP_REG_CONFIG_MMSYS_CG_SET0,1);
			*/
			break;
		case DISP_MODULE_DSIDUAL:
			/*
